...
{
    echo "metric,ember,ember-grpc,chromadb,pgvector"
    echo "insert_throughput,$E_INSERT,$EG_INSERT,$C_INSERT,$P_INSERT"
    echo "query_throughput,$E_QUERY,$EG_QUERY,$C_QUERY,$P_QUERY"
    echo "query_p50_ms,$E_P50,$EG_P50,$C_P50,$P_P50"
    echo "query_p95_ms,$E_P95,$EG_P95,$C_P95,$P_P95"
    echo "query_p99_ms,$E_P99,$EG_P99,$C_P99,$P_P99"
